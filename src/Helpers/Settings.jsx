            ...
            {isOpen && (
                <div className="origin-top-right absolute z-20 right-0 mt-2 w-44 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                    <ul role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                        <li>
                            <a href="/about" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={closeDropdown}>
                                About Me
                            </a>
                        </li>
                        <li>
                            <a href="/update" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={closeDropdown}>
                                Update Password
                            </a>
                        </li>
                        <li>
